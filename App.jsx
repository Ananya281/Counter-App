...
function App() {
  ...
  //ab decreaseHandler shi kaam karega, hmne isko useState hook se attach kr diya aur setCount bol diya count-1, to ab value bhi decrease ho gyi aur sath hi rerender bhi ho jayega UI pr
